...
: G4VUserDetectorConstruction(){
    ...
    flscanRot = new G4RotationMatrix();
...
G4VPhysicalVolume* PrtDetectorConstruction::Construct(){
    ...
    G4Material *Vacum2=G4NistManager::Instance()->FindOrBuildMaterial("G4_Galactic");
    
    flscanRot->rotateY(90*deg);
...
//            new G4PVPlacement(flscanRot,G4ThreeVector(15,10.4288,-108.534),lScan,"wScan",lExpHall,false,0); // (15,10.4288,-108.534) point from PixSD coorispond to 447
//
            ...
            //G4Box* gScan2 = new G4Box("gScan2",fBar[0]/2.,fBar[1]/2.,0.00000001);
            //G4LogicalVolume *lScan2 = new G4LogicalVolume(gScan2, Vacum2 ,"lScan2",0,0,0);
...
void PrtDetectorConstruction::SetVisualization(){
    ...
    G4VisAttributes *wScan_color = new G4VisAttributes(red);
    wScan_color->SetVisibility(true);
    lScan->SetVisAttributes(wScan_color);
