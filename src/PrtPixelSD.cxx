...
G4bool PrtPixelSD::ProcessHits(G4Step* step, G4TouchableHistory* hist) {
    ...
    */
    ...
    Int_t mcpid=PrtManager::Instance()->GetTest1();
    Int_t pixid=PrtManager::Instance()->GetTest2();

    //std::cout<<"#########  ################# MCP: " << mcpid<<" pix: "<< pixid<< "   mom_phs.x="<<mom_phs.x()<< "   mom_phs.y="<<mom_phs.y()<< "   mom_phs.z="<<mom_phs.z()<<"  time= "<< time<<std::endl;
    hit.SetMcpId(mcpid);
